...
% % --- Exp1 ----------------------
% Same amount of layers, the kernels of the convolutional layers 
% are changed from 5x5 to 8x8

% layers = [imageInputLayer([28 28 1])
%           convolution2dLayer(8,12)
%           reluLayer
%           
%           maxPooling2dLayer(2,'Stride',2)
%           
%           convolution2dLayer(8,24)
%           reluLayer  
%           
%           fullyConnectedLayer(10)
%           softmaxLayer
...
% --- Exp. 2 ----------------------
% A max average pooling layer 2x2 is added before the fully connected layer
...
% --- Exp. 3 ----------------------
% Same amount of layers as in the default architecture, 
% but the convolutional kernel sizes are changed from 5x5(default) to 3x3
...
% --- Exp. 4  ----------------------
% Same number of layers as in the default network, 
% but the number of kernels in each convolutional layer is doubled 
% in relation to the default network's
...
% - The first argument is |filterSize|, which is the
...
% height and the width of the filter. 
...
% |poolSize|. 
% In this example, the size of the rectangular region is [2,2]. The optional
...
%--------------------------------------------------
% Create accuracy histogram from all experiments
X = categorical({'Default Architecture','Conv. Kernels size 8x8','MaxPool 2x2 before FC Layer','Conv. Kernels size 3x3','Double filters in conv. layers','No pooling layers','Double kernels in conv. layers & no pooling'});
X = reordercats(X,{'Default Architecture','Conv. Kernels size 8x8','MaxPool 2x2 before FC Layer','Conv. Kernels size 3x3','Double filters in conv. layers','No pooling layers','Double kernels in conv. layers & no pooling'});
Y = [0.81 , 0.27, 0.49,0.91,0.96, 0.96,0.98];
...
title("Experiments with different CNN Architectures")
ylabel("Accuracy (%)")
